export const ScopeFoundationCore = {
  ...
  'BCSE101E - Computer Programming: Python': [
    { slot: 'TBB2', venue: 'SJT503', faculty: 'VASANTHI P' },
    { slot: 'L5+L6+L27+L28', venue: 'PRP356', faculty: 'VASANTHI P' },
  ],
  'BCSE102L - Structured and Object-Oriented Programming': [
    { slot: 'D1', venue: 'SJT522', faculty: 'RAMESH BABU VEMULURI' },
    { slot: 'D1', venue: 'SJT607', faculty: 'KEYUR BHANUPRASAD JOSHI' },
    { slot: 'D2', venue: 'SJT604', faculty: 'JUSTUS RAJU KARACKATTUVILAYIL' },
    { slot: 'D2', venue: 'SJT522', faculty: 'KEYUR BHANUPRASAD JOSHI' },
  ],
  'BCSE102P - Structured and Object-Oriented Programming Lab': [
    { slot: 'L5+L6+L23+L24', venue: 'PRP137', faculty: 'KEYUR BHANUPRASAD JOSHI' },
    { slot: 'L33+L34+L37+L38', venue: 'SJT517', faculty: 'RAMESH BABU VEMULURI' },
    { slot: 'L47+L48+L59+L60', venue: 'PRP136', faculty: 'KEYUR BHANUPRASAD JOSHI' },
    { slot: 'L1+L2+L11+L12', venue: 'PRP136', faculty: 'JUSTUS RAJU KARACKATTUVILAYIL' },
  ],
  'BCSE103E - Computer Programming: Java': [
    { slot: 'TAA2', venue: 'SJT503', faculty: 'SENTHIL KUMAR K' },
    { slot: 'TAA1', venue: 'SJT504', faculty: 'BALAJI N' },
    { slot: 'TAA2', venue: 'SJT504', faculty: 'BALAJI N' },
    { slot: 'TAA1', venue: 'SJT505', faculty: 'SARASWATHI U' },
    { slot: 'TCC1', venue: 'TT619', faculty: 'POONGUNDRAN SELVAPRABHU' },
    { slot: 'L33+L34+L43+L44', venue: 'TT232', faculty: 'POONGUNDRAN SELVAPRABHU' },
    { slot: 'L5+L6+L21+L22', venue: 'PRP350', faculty: 'SENTHIL KUMAR K' },
    { slot: 'L1+L2+L29+L30', venue: 'PRP232', faculty: 'BALAJI N' },
    { slot: 'L47+L48+L49+L50', venue: 'PRP232', faculty: 'BALAJI N' },
    { slot: 'L35+L36+L49+L50', venue: 'PRP234', faculty: 'SARASWATHI U' },
  ],
