import { SmecDisciplineCore } from './DisciplineCore';
import { SmecDisciplineElective } from './DisciplineElective';
import { SmecDisciplineELinked } from './DisciplineLinked';
...
export const SMEC_LIST = {
  ...
  DisciplineCore: SmecDisciplineCore,
  DisciplineElective: SmecDisciplineElective,
  DisciplineLinkedEngineeringSciences: SmecDisciplineELinked,
